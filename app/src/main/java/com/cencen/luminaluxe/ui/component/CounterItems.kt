    ...
    Row (
        ...
        Surface(
            ...
            Text(
                ...
                modifier = Modifier
                    .weight(1f)
                    .clickable { onItemDecreased(orderId) }
                )
        }
        Text(
        ...
        Surface(
            ...
            Text(
                ...
                modifier = Modifier
                    .weight(1f)
                    .clickable { onItemIncreased(orderId) }
            )
        }
    }
}
...
@Preview
@Composable
fun CounterItemsPreview() {
    LuminaLuxeTheme {
        CounterItems(orderId = 1, orderCounter = 0, onItemIncreased = {} , onItemDecreased = {} )
    }
}
